...
<div class="images clearfix"><?php 
	...
	<div class="title"><?php echo JText::_( 'COM_MTREE_IMAGES' ); ?> (<?php 
	 ...
	 ?>)</div><?php } ?>
	<div class="component_content clearfix"><?php
		$i = 0;
		...
		foreach ($this->images AS $image): 
			...
			{
				?>
				<div class="thumbnail first" itemprop="image">
		...
		?>
		<div class="thumbnail-left"><a class="listingimage" rel="group1" href="<?php echo $this->jconf['live_site'] . $this->mtconf['relative_path_to_listing_original_image'] . $image->filename; ?>"><img src="<?php 
