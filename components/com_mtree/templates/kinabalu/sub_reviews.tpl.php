        ...
        ?></div>
                    ...
                    if (( ($this->mtconf['user_report_review'] == 1 && $this->my->id > 0) || $this->mtconf['user_report_review'] == 0) || ( $this->my->id == $this->link->user_id && empty($review->ownersreply_text) )) {
                        if (($this->mtconf['user_report_review'] == 1 && $this->my->id > 0) || $this->mtconf['user_report_review'] == 0) {
                            ?><div class="review-report"><a class="colorbox" href="<?php echo JRoute::_('index.php?option=' . $this->option . '&amp;task=reportreview&amp;rev_id=' . $review->rev_id.'&tmpl=component') ?>"><?php echo JText::_('COM_MTREE_REPORT_REVIEW'); ?></a></div><?php
                        }
                ...
                <?php if($this->my->id > 0) { ?>
                <p>
                    <a class="colorbox" href="<?php echo JRoute::_('index.php?option=com_mtree&task=writereview&link_id=' . $this->link->link_id.'&tmpl=component'); ?>"><?php echo JText::_('COM_MTREE_WRITE_REVIEW'); ?><span class="lucida button-arrow">»</span></a>
                </p>
                <?php } ?>
                <?php
            }
