...
$createdAt = $link_fields->getFieldById(18);
...
?><div class="clearfix listing-summary<?php
...
?></h3>
            ...
            if ($number_of_ls_columns == 1) {
                ...
                //                    РІС‹РІРѕРґРёРј РґР°С‚Сѓ
                echo '<span class="list-date-created">' . $createdAt->getOutput(2) . '</span>';
            ...
            echo '<div class="summary_info clearfix">';
        ...
        while ($link_fields->hasNext()) {
            ...
            if (
                    ...
                    (
                    ($this->config->getTemParam('displayAddressInOneRow', '1') && !in_array($field->getId(), array(4, 5, 6, 7, 8, 18)) ||
